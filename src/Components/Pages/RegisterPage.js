...
<section>
                        ...
                        <div id="single-form-next" class="multisteps-form__panel shadow p-4 rounded bg-white js-active" data-animation="scaleIn">
                            ...
                            <div id="form-content" class="multisteps-form__content">
                                <div id="input-grp-double" class="form-row mt-4">
                                    <div class="col-12 col-sm-6"><input class="form-control multisteps-form__input" type="text" placeholder="Pseudo" name="pseudo" id="pseudo"></div>
                                </div>
                                <div id="input-grp-double-3" class="form-row mt-4">
                                    <div class="col-12 col-sm-6"><input class="form-control multisteps-form__input" type="text" placeholder="Mail" name="mail" id="email"></div>
                                </div>
                                <div id="input-grp-single" class="form-row mt-4">
                                    <div class="col-12"><input class="form-control" type="password" placeholder="Password" name="password" id="password"></div>
                                </div>
                                <div id="input-grp-single" class="form-row mt-4">
                                    <div class="col-12"><input class="form-control" type="password" placeholder="Password" name="password" id="password-repeat"></div>
                                </div>
                            ...
                            <div id="form-content-1" class="multisteps-form__content">
                                <div id="input-grp-double-1" class="form-row mt-4">
                                    <div class="col-12 col-sm-6">
                                        <div class="form-check"><input class="form-check-input" type="radio" id="gender"><label class="form-check-label" for="formCheck-3" value="male">Male</label></div>
                                    </div>
                                    <div class="col-12 col-sm-6">
                                        <div class="form-check"><input class="form-check-input" type="radio" id="gender"><label class="form-check-label" for="formCheck-3" value="female">Female</label></div>
                                    </div>
                                    <div class="col-12 col-sm-6">
                                        <div class="form-check"><input class="form-check-input" type="radio" id="gender"><label class="form-check-label" for="formCheck-3" value="neutral">Neutral</label></div>
                                    </div><!--formCheck-3 switch to gender in css-->
                                </div>
                                <div id="input-grp-single-1" class="form-row mt-4">
                                    <div class="col-12"><input class="form-control multisteps-form__input" type="text" id="favourite_pokemon" placeholder="Favorite  Pokemon"></div>
                                </div>
                            </div>
                        </div>
                        <div id="single-form-next-prev-1" class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                            ...
                            <div id="form-content-2" class="multisteps-form__content">
                                <div id="input-grp-double-2" class="form-row mt-4">
                                    <div class="col-12 col-sm-6"><input class="form-control multisteps-form__input" type="text" placeholder="Country" id="country"></div>
                                    <div class="col-12 col-sm-6 mt-4 mt-sm-0"><input class="form-control multisteps-form__input" type="text" placeholder="City" id="city"></div>
                                </div>
 ...
 const RegisterPage = () => { 
    ...
    async function onSubmit(e) {
        ...
        const favourite_pokemon = document.getElementById("favourite_pokemon");
        const country = document.getElementById("country");
        

        console.log("credentials", email.value, password.value, password_repeat.value);
        ...
        try {
            const options = {
                ...
                password : password_repeat.value
